...
}],"date.js":["lodash","moment",function(require,exports){
...
exports.today = today;                                                                                                 // 4
function createDay(year, month, day) {                                                                                 // 9
    return new Date(year, month, day, 0, 0, 0);                                                                        //
}                                                                                                                      // 11
exports.createDay = createDay;                                                                                         // 9
function addDays(date, days) {                                                                                         // 12
    return createDay(date.getFullYear(), date.getMonth(), date.getDate() + days);                                      //
}                                                                                                                      // 14
exports.addDays = addDays;                                                                                             // 12
function firstDayOfMonth(month) {                                                                                      // 15
    return createDay(month.getFullYear(), month.getMonth(), 1);                                                        //
}                                                                                                                      // 17
exports.firstDayOfMonth = firstDayOfMonth;                                                                             // 15
function calendarDaysForMonth(month) {                                                                                 // 18
    var days = [];                                                                                                     //
...
exports.calendarDaysForMonth = calendarDaysForMonth;                                                                   // 18
...
function weeksForMonth(month) {                                                                                        // 46
...
exports.weeksForMonth = weeksForMonth;                                                                                 // 46
...
function orderCheckAgainstTrigger(order, trigger, api) {                                                               // 8
...
exports.orderCheckAgainstTrigger = orderCheckAgainstTrigger;                                                           // 8
function orderQueryTriggers(order, triggers, api) {                                                                    // 59
    var triggered = [];                                                                                                //
...
exports.orderQueryTriggers = orderQueryTriggers;                                                                       // 59
function orderCheckAgainstTriggers(order, triggers, api) {                                                             // 70
...
exports.orderCheckAgainstTriggers = orderCheckAgainstTriggers;                                                         // 70
function orderFlagged(order, api) {                                                                                    // 81
    for (var _i = 0, _a = order.bundles; _i < _a.length; _i++) {                                                       //
        var bundle = _a[_i];                                                                                           //
...
exports.orderFlagged = orderFlagged;                                                                                   // 81
function orderFulfillmentDays(order, api) {                                                                            // 108
...
exports.orderFulfillmentDays = orderFulfillmentDays;                                                                   // 108
function excludeAvailabilityDate(opts) {                                                                               // 121
...
exports.excludeAvailabilityDate = excludeAvailabilityDate;                                                             // 121
function orderTotalMeals(order) {                                                                                      // 146
...
exports.orderTotalMeals = orderTotalMeals;                                                                             // 146
function bundlePrice(bundle) {                                                                                         // 155
    if (bundle.promotion) {                                                                                            //
        var promotionPrice;                                                                                            //
...
exports.bundlePrice = bundlePrice;                                                                                     // 155
function allergyTotal(allergy, bundle) {                                                                               // 171
...
exports.allergyTotal = allergyTotal;                                                                                   // 171
function bundlePremiumTotal(bundle) {                                                                                  // 191
    var total = 0;                                                                                                     //
...
exports.bundlePremiumTotal = bundlePremiumTotal;                                                                       // 191
function bundleTotal(bundle) {                                                                                         // 207
...
exports.bundleTotal = bundleTotal;                                                                                     // 207
function orderSubtotal(order) {                                                                                        // 227
    var subtotal = 0;                                                                                                  //
    var allergyRemovals = {};                                                                                          //
    for (var _i = 0, _a = order.bundles; _i < _a.length; _i++) {                                                       //
        var bundle = _a[_i];                                                                                           //
...
exports.orderSubtotal = orderSubtotal;                                                                                 // 227
function orderTotal(order) {                                                                                           // 239
    var total = order.subtotal + order.deliveryFee;                                                                    //
    return round(total);                                                                                               //
}                                                                                                                      // 242
exports.orderTotal = orderTotal;                                                                                       // 239
function orderLocationSurcharge(order, api) {                                                                          // 244
...
exports.orderLocationSurcharge = orderLocationSurcharge;                                                               // 244
function orderDeliveryFee(order, api) {                                                                                // 253
...
exports.orderDeliveryFee = orderDeliveryFee;                                                                           // 253
...
}],"anomalyTriggers.js":["meteor/mongo",function(require,exports){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var mongo_1 = require('meteor/mongo');                                                                                 // 1
exports.AnomalyTriggers = new mongo_1.Mongo.Collection('anomalyTriggers', { idGeneration: 'MONGO' });                  // 2
//# sourceMappingURL=anomalyTriggers.js.map                                                                            //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
}},"server":{"main.js":["meteor/meteor","meteor/mongo","../api/orders","../api/meals","../api/addOns","../api/bundleTypes","../api/mealPlans","../api/anomalyTriggers","../api/timeSlots","../api/promotions","../api/fulfillmentSettings","../api/locationSurcharges","../api/ingredients","../api/portions","../api/blocks","../common/scripts/date.ts","../common/scripts/DateSet.ts","lodash","../common/scripts/order.ts","meteor/http",function(require,exports){
...
var anomalyTriggers_1 = require('../api/anomalyTriggers');                                                             // 8
var timeSlots_1 = require('../api/timeSlots');                                                                         // 9
var promotions_1 = require('../api/promotions');                                                                       // 10
var fulfillmentSettings_1 = require('../api/fulfillmentSettings');                                                     // 11
var locationSurcharges_1 = require('../api/locationSurcharges');                                                       // 12
var ingredients_1 = require('../api/ingredients');                                                                     // 14
var portions_1 = require('../api/portions');                                                                           // 15
var blocks_1 = require('../api/blocks');                                                                               // 16
var date_ts_1 = require('../common/scripts/date.ts');                                                                  // 17
var DateSet_ts_1 = require('../common/scripts/DateSet.ts');                                                            // 18
var _ = require('lodash');                                                                                             // 19
var order_ts_1 = require('../common/scripts/order.ts');                                                                // 20
var http_1 = require('meteor/http');                                                                                   // 22
function getToday() {                                                                                                  // 24
    var now = new Date();                                                                                              //
    return date_ts_1.createDay(now.getFullYear(), now.getMonth(), now.getDate());                                      //
}                                                                                                                      // 27
;                                                                                                                      // 49
;                                                                                                                      // 53
exports.Errors = new mongo_1.Mongo.Collection('errors', { idGeneration: 'MONGO' });                                    // 168
if (!('toJSON' in Error.prototype))                                                                                    // 172
...
function amPm(time, appendSuffix) {                                                                                    // 197
...
var _mealStock = null;                                                                                                 // 207
var _mealStockDate = null;                                                                                             // 208
function getMealStock() {                                                                                              // 209
    var today = getToday();                                                                                            //
...
var OrderApi = (function () {                                                                                          // 219
    function OrderApi() {                                                                                              //
        this._mealStock = null;                                                                                        //
        this.fulfillmentSettings = fulfillmentSettings_1.FulfillmentSettings.findOne();                                //
        this.anomalyTriggers = anomalyTriggers_1.AnomalyTriggers.find().fetch();                                       //
    }                                                                                                                  //
...
function timeSlotsForMonth(month) {                                                                                    // 250
    return timeSlotsForDates(date_ts_1.calendarDaysForMonth(month));                                                   //
}                                                                                                                      // 252
exports.timeSlotsForMonth = timeSlotsForMonth;                                                                         // 250
function timeSlotsForDates(dates) {                                                                                    // 254
...
exports.timeSlotsForDates = timeSlotsForDates;                                                                         // 254
function createOrder(orderData, userId, opts) {                                                                        // 312
    if (opts === void 0) { opts = {}; }                                                                                //
    try {                                                                                                              //
...
exports.createOrder = createOrder;                                                                                     // 312
function availablilityDatesForOrder(order) {                                                                           // 483
    var excluded = [                                                                                                   //
        ['dayOfYear', '10-29'],                                                                                        //
        ['dayOfYear', '09-12']                                                                                         //
    ];                                                                                                                 //
    ...
    availabilityDates.addRule('exclude', order_ts_1.excludeAvailabilityDate({                                          //
        ...
        fulfillmentDays: function () { return order_ts_1.orderFulfillmentDays(order, orderApi); },                     //
        api: orderApi                                                                                                  //
    }));                                                                                                               //
...
exports.availablilityDatesForOrder = availablilityDatesForOrder;                                                       // 483
// TODO: Eliminate nesting                                                                                             // 515
function validatePromotion(userId, order, promotion) {                                                                 // 516
    if (promotion) {                                                                                                   //
        var now = new Date();                                                                                          //
...
exports.validatePromotion = validatePromotion;                                                                         // 516
function resolveOrder(orderData, userId) {                                                                             // 581
...
exports.resolveOrder = resolveOrder;                                                                                   // 581
